import { ButtonContent, ChapterContent, ClassiqueChapterContent, ImageContent, InfoBoxContent, ReferencesContent, RelatedSubjectContent, SubjectContent, SummaryContent, TextContent, TOCContent, WikiContent } from "../kernel/models/content"
...
const chapter3:ChapterContent = new ClassiqueChapterContent(
    ...
    [new TextContent("Cette espèce est <a href=\"\">endémique</a> de l'Est de la <a href=\"\">Thaïlande</a>."),new ImageContent('https://commons.wikimedia.org/wiki/File:Lizardicon.svg?uselang=fr',"un lezard"),new ButtonContent('https://fr.wikipedia.org/wiki/Tropidophorus_matsuii',"wikipedia page")]
)

const infoBox :InfoBoxContent = new InfoBoxContent([new TextContent(`<ul>endémique<li> </li><li>originale</li><li>Masafumi Matsui</li></ul>`)])
